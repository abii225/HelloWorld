...
<div style={{position:"absolute"}}>
  {/* 1rd row............... */}
    ...
    <div className="mediaqueryOuterDiv flex flex-col justify-center w-11/12 m-[auto] md:flex-row">
        <div className="mediaqueryInnerDiv1 w-[46%] flex flex-col text-center mr-[5rem]" style={{alignItems:"center"}}>
            <p className="mediaqueryInnerDiv1p text-3xl text-center w-3/4 mt-[1.6rem] font-bold" ><b style={{color:"rgb(0,168,132)"}}>Intellibot.</b>  End-to-End AI Video Interview Software</p>
            <p className=" text-justify mt-[20px] mb-[20px]" style={{lineHeight:"2"}}>Intellibot is all about efficiency. It’s a state-of-the-art video recruiting software that uses Explainable AI to pre-screen and shortlist candidates, bringing the best talent out there for the role you’re looking for. Our online smart video interview software cuts the time of unnecessary pre-interviews, giving you more time to focus on what’s really important – your company. Our software is powered by top-notch AI hiring technology, analyzing key factors of potential candidates, including psychological and technical aspects.</p>
...
{/* 2rd row............... */}
    ...
    <div  style={{width:"42%"}}>
        ...
        <div className="w-[46%] text-justify flex flex-col justify-center" >
            ...
            <p className="text-left" style={{marginTop:"15px",marginBottom:"15px", fontSize:"1.3rem"}}>You may know the answer or approach to the question, but expressing it in words swiftly is what makes interviews challenging to face..</p>
...
{/* 3rd row............... */}
    <div className="flex justify-center w-11/12 m-[auto] mt-[5rem] mb-[4rem]">
        ...
        <div className="w-[46%] text-justify flex flex-col justify-center" >
            <p className="text-3xl text-left w-3/4 font-bold" >AI Analysed Feedback</p>
            <p className="text-left" style={{marginTop:"15px",marginBottom:"15px", fontSize:"1.3rem"}}>Get detailed interview feedback that provides you insights on your skills and feedback for every question answered.</p>
...
<p className="text-3xl mt-[20px] mb-[4rem] line-">Tailored solution to make you <b><i style={{color:"rgb(15,174,83)"}}>Interview Ready</i></b></p>
</div>
...
<footer className="bg-white dark:bg-gray-900">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="https://flowbite.com/" className="flex items-center">
                  ...
                  <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Intellibot</span>
              </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 w-[70%]">
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="https://flowbite.com/" className="hover:underline">Intellibot</a>
                      </li>
                      <li>
      ...
      <div className="sm:flex sm:items-center sm:justify-around">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Intellibot™</a>. All Rights Reserved.
          </span>
